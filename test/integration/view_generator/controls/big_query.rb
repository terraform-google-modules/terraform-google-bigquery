...
describe google_bigquery_table(project: "#{project_id}", dataset: "#{dataset_name}", name: "#{tables["foo"]["friendly_name"]}_view") do
  it { should exist }
end

describe google_bigquery_table(project: "#{project_id}", dataset: "#{dataset_name}", name: "#{tables["bar"]["friendly_name"]}_view") do
  it { should exist }
end
